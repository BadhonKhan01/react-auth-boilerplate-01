...
const Profile = (props) => {
    ...
    --------------------------------------*/
    const editId = props.user.userData.id;
    ...
    //   @Load Data
    //--------------------------------*/  
    const getDispatch = props.dispatch;
    useEffect(() => {
        getDispatch(getSingleUser(editId)).then(response => {
    ...
    }, [cloneFormData, editId, getDispatch])
                        ...
                        <div className="auth-form-area">
                            ...
                            <form onSubmit={(event) => submitForm(event)} className="row">
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    ----------------------------------- */}
                                    <div className="mr-2">
                                        <CheckStatus status={formdata.status.value} />
                                    </div>
